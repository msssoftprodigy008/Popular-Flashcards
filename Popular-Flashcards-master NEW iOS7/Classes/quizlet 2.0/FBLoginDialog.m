...
- (void) dialogDidSucceed:(NSURL*)url {
  ...
  if ((code == (NSString *) [NSNull null]) || (code.length == 0)) {
    ...
    if (_loginDelegate && [_loginDelegate respondsToSelector:@selector(fbDialogLogin:expirationDate:)]) {
      [_loginDelegate fbDialogLogin:code expirationDate:expirationDate];
    }
